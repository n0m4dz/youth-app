                    ...
                    children: jobs.map(
                        ...
                        return Container(
                            ...
                            decoration: BoxDecoration(
                                border: Border.all(color: lawColor.withOpacity(0.3), width: 1, style: BorderStyle.solid),
                                              ...
                                              children: [
                                                Flexible(
                                                  child: Text(
                                                    ...
                                                    maxLines: 1,
                                                    softWrap: false,
                                                    style: TextStyle(color: lawColor, fontWeight: FontWeight.bold, fontSize: 18),
                                                  ),
                                                ),
                                              ],
                                            ),
                                ...
                                Positioned(
                                    ...
                                    child: GestureDetector(
                                        onTap: (){
                                          Navigator.push(
                                              context,
                                              MaterialPageRoute(builder: (context) => LawDetailPage(
                                                title: item['title'],
                                                thumb: item['thumb'],
                                                body: item['body'],
                                                link: item['link'],
                                        ...
                                        child: Row(
                                          children: [
                                            Container(
                                              ...
                                              child: Text(
                                                'Ца'.toUpperCase(),
                                                style: TextStyle(color: lawColor, fontSize: 14),
                                              ),
                                            ),
                                            Container(
                                              padding: EdgeInsets.only(
