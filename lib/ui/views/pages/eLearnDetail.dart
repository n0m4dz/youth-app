...
class ELearnDetailPage extends StatefulWidget{
  ...
  const ELearnDetailPage({Key key, this.title, this.thumb, this.created_at, this.description, this.body, this.teachername, this.updated_at}) : super(key: key);
                    ...
                    Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Text(
                              widget.updated_at == null ? '' : DateFormat("y/MM/dd").format(DateTime.parse(widget.updated_at)).toString(),
                    ...
                    Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Text(
                              widget.teachername == null ? '__' : widget.teachername.toString(),
                              style: TextStyle(color: podCastColor, fontWeight: FontWeight.w500, fontSize: 14),
                            ),
                          ],
                        )
