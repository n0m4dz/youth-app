...
class YouthTipsDetail extends StatefulWidget {
  final Resolution item;

  const YouthTipsDetail({Key key, this.item}) : super(key: key);
  @override
  _YouthTipsDetailState createState() => _YouthTipsDetailState();
}

class _YouthTipsDetailState extends State<YouthTipsDetail> {
  @override
