...
import 'package:youth/ui/views/pages/subYouthCouncil/youth_tips_detail.dart';

import '../../../../size_config.dart';
import '../../base_view.dart';

class YouthTips extends StatefulWidget {
  final int aimagId;

  const YouthTips({Key key, this.aimagId}) : super(key: key);
  @override
  _YouthTipsState createState() => _YouthTipsState();
}

class _YouthTipsState extends State<YouthTips> {
    ...
    return Scaffold(
      ...
      body: NestedScrollView(
        ...
        body: BaseView<ResolutionModel>(
          onModelReady: (model) {
            model.getResolutionList(widget.aimagId, 120, 1, action: 'refresh');
          },
                        ...
                        return InkWell(
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => YouthTipsDetail(
                                  item: item,
                                ),
                              ),
                            );
