...
class _VolunteerWorksState extends State<VolunteerWorks> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        //     onModelReady: (model) {
        //       model.getVolunteerModelWorkList(1, action: "refresh");
        //     },
        ...
        //             onRefresh: () async {
        //               await model.getVolunteerModelWorkList(1, action: "refresh");
        //               await Future.delayed(Duration(milliseconds: 1000));
        //               _refreshController.refreshCompleted();
        //             },
        //             onLoading: () async {
        //               await model.getVolunteerModelWorkList(model.page + 1,
        //                   action: "more");
        //               await Future.delayed(Duration(milliseconds: 1000));
